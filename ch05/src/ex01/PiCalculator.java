...
/**
 * Class used to calculate PI. Provides one method to calculate PI to the n-th
...
public class PiCalculator {
	...
	/**
	 * Calculates PI using the formula "4*(1 - 1/3 + 1/5 - 1/7 + 1/9 - ...)" to
	 * the n-th place after the decimal point.
	 * 
	 * @param placesAfterDecimalPoint
	 *            Defines how many places after the decimal point are evaluated.
	...
	public double calcPi(int placesAfterDecimalPoint) {
		...
		double piCalc = 1D;
		long fraction = 3;
		int operation = -1; // First operation is "1 - 1/3"
	 ...
	 * @param k
	 *            The number will be rounded for k places after the decimal
	 *            point
